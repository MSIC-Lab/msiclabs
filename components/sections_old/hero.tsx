...
const hero = () => {
  return (
    <>
      <main className="w-screen px-20 h-[calc(100vh-4rem)] bg-gradient-to-r from-violet-50  via-purple-100 to-fuchsia-50 flex justify-center items-start bg-fixed ">
        <div className="max-w-[1200px] w-[95%] sm:w-full  flex justify-center items-center text-center flex-col">
          <div
            className="py-36 sm:px-16 text-blue-600 "
          >
            <Fadein
